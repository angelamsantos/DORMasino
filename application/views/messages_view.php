                                ...
                                <ul class="list-group">
                                    <li class="list-group-item" style="padding: 0px;">
                                        <div class="col d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex align-items-center align-items-sm-center align-items-md-center flex-lg-row align-items-lg-center flex-xl-row align-items-xl-center" style="padding: 0px 15px;margin: 5px 0px;">
                                            <div class="form-check d-flex d-sm-flex d-md-flex d-xl-flex align-items-center align-items-sm-center align-items-md-center align-items-lg-center mr-lg-auto align-items-xl-center mr-xl-auto" style="width: 10%;"><input class="form-check-input my-auto my-sm-auto my-md-auto my-lg-auto my-xl-auto" type="checkbox" id="formCheck-1"><label class="form-check-label" for="formCheck-1"><button class="btn btn-primary d-xl-flex ml-auto" type="button" id="user" style="padding-bottom: 0px;padding-top: 0px;padding-right: 0px;padding-left: 0px;line-height: 22px;font-size: 14px;border-radius: 100px;margin-top: 0px;background-color: transparent;border: none;height: 29px;width: 30.2188px;margin-right: 10px;margin-bottom: 0px;" title="Add Tenant" data-toggle="modal" data-target="#AddUser"><i class="icon ion-android-archive" style="font-size: 24px;color: #555555;padding-left: 0px;margin-left: 4.8px;"></i>&nbsp;</button></label></div>
                                            <select
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-xl-12" style="text-align:left"><label class="col-form-label" style="font-weight: normal;">To</label></div>
                                                <div class="col-xl-12">
                                                    <select name="room_id" id="to"  class="form-control multiple-select" required>
