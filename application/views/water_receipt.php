                          ...
                          <tbody>
                            <tr>
							  ...
							  <td style="width:50%; text-align:right" >
								Receipt No: <?php echo $wtrans_rno; ?>
							  <td>
                            </tr>
							<tr>
                              <td >
							...
							<tr >
							  <td style="width:50%;text-indent:25px; text-align:justify;padding: 20px 15px;" colspan="2">
								Received from <b><?php echo $a." ".$b; ?></b>, Unit <b><?php echo $c; ?></b> the amount of <b>Php <?php echo number_format($wtrans_amount, 2); ?></b> as <b>water payment</b> for the month of 
                <b><?php echo date('F', strtotime($e)); ?></b>.
							  <td>
                            </tr>
