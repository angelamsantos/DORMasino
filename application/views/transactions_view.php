                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                <button title="Open Rent" type="button" id="edit-tenant" data-toggle="modal" data-target="#MoveRoom" class="btn btn-primary" style="border-radius:90px 90px 90px 90px;padding:0px 8px;margin-right:0px">
                                                    <i class="fas fa-key" style="font-size:17px;color:#0645AD;"></i>
                                                </button>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <button title="Change contract" type="button" id="edit-tenant" data-target="#ChangeContract" data-toggle="modal" class="btn btn-primary" style="border-radius:90px 90px 90px 90px;padding:0px 8px;margin-right:0px">
