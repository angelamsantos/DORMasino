        ...
        <div class="container-fluid justify-content-center">
            ...
            <div class="row d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center mx-auto flex-sm-column align-items-sm-center flex-md-column align-items-md-center flex-lg-row justify-content-lg-center flex-xl-row justify-content-xl-center align-items-xl-center"
                ...
                <div class="col-12 col-sm-7 col-md-8 col-lg-3 col-xl-3 d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex flex-column align-items-center align-items-sm-center justify-content-md-center align-items-md-center justify-content-xl-center align-items-xl-center service"
                    style="background-color: #5dc2fe;padding: 15px;padding-top: 15px;"><button class="btn btn-primary btn-home" onclick="location.href='Directories/index'" type="button" style="background-color: transparent;border: none; "><img src="<?php echo base_url(); ?>/assets/img/user.png" width="120"></button>
                    <h3>Directories</h3>
                </div>
                <div class="col-12 col-sm-7 col-md-8 col-lg-3 col-xl-3 d-flex d-sm-flex d-md-flex d-xl-flex flex-column align-items-center align-items-sm-center align-items-md-center justify-content-xl-center align-items-xl-center service" style="background-color: #5dc2fe;padding: 15px;"><button class="btn btn-primary btn-home" type="button" onclick="location.href='Transactions/index'" ><img src="<?php echo base_url(); ?>/assets/img/bills.png" width="120"></button>
                    <h3>Transactions</h3>
                </div>
                <div class="col-12 col-sm-7 col-md-8 col-lg-3 col-xl-3 d-flex d-sm-flex d-md-flex d-xl-flex flex-column align-items-center align-items-sm-center align-items-md-center justify-content-xl-center align-items-xl-center service" style="background-color: #5dc2fe;padding: 15px;"><button class="btn btn-primary d-xl-flex btn-home" type="button" onclick="location.href='Announcements/index'"><img src="<?php echo base_url(); ?>/assets/img/request.png" width="120"></button>
                    <h3>Announcements</h3>
                </div>
            </div>
            <div class="row d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center mx-auto flex-sm-column align-items-sm-center flex-md-column align-items-md-center flex-lg-row justify-content-lg-center flex-xl-row justify-content-xl-center align-items-xl-center"
                id="home-menu" style="margin-top: 9px;margin-right: 0px;margin-left: 0px;width: 95%;">
                <div class="col-12 col-sm-7 col-md-8 col-lg-3 col-xl-3 d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex flex-column align-items-center align-items-sm-center justify-content-md-center align-items-md-center justify-content-xl-center align-items-xl-center service"
                    style="background-color: #5dc2fe;padding: 15px;padding-top: 15px;"><button onclick="location.href='Messages/index'" class="btn btn-primary btn-home" type="button" style="background-color: transparent;border: none;"><img src="<?php echo base_url(); ?>/assets/img/chat.png" width="120"></button>
                    <h3>Messages</h3>
                </div>
                <div class="col-12 col-sm-7 col-md-8 col-lg-3 col-xl-3 d-flex d-sm-flex d-md-flex d-xl-flex flex-column align-items-center align-items-sm-center align-items-md-center justify-content-xl-center align-items-xl-center service" style="background-color: #5dc2fe;padding: 15px;"><button class="btn btn-primary btn-home" type="button" onclick="location.href='Logs/index'"><img src="<?php echo base_url(); ?>/assets/img/login.png" width="120"></button>
                    <h3>Visitor Logs</h3>
                </div>
                <div class="col-12 col-sm-7 col-md-8 col-lg-3 col-xl-3 d-flex d-sm-flex d-md-flex d-xl-flex flex-column align-items-center align-items-sm-center align-items-md-center justify-content-xl-center align-items-xl-center service" style="background-color: #5dc2fe;padding: 15px;"><button class="btn btn-primary d-xl-flex btn-home" type="button" onclick="location.href='Settings/index'"><img src="<?php echo base_url(); ?>/assets/img/settings.png" width="120"></button>
                    <h3>Settings</h3>
                </div>
            </div>
        </div>
